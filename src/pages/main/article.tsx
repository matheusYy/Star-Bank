  ...
  <div  className="divApresentation">
    <div className="title-init">
     <div className="tittleContainer">
       <h1>Apenas um toque para começar</h1>
     </div>
    </div>
   ...
   <path d="M10.8881 15.656V13.3019C10.8881 10.3699 12.9515 9.17166 15.478 10.6377L17.5133 11.8218L19.5486 13.0059C22.0752 14.4719 22.0752 16.8683 19.5486 18.3343L17.5133 19.5184L15.478 20.7025C12.9515 22.1685 10.8881 20.9703 10.8881 18.0383V15.656Z" stroke="#F0803C" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
   </svg>
   COMEÇAR
   </button>
