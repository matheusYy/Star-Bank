...
function moveScroll() {
 ...
 <article  className="containerArticleInit">
  <div  className="divApresentation">
   ...
   <aside className="content-button-flex">


    <LineLinear /> 
     <div className="buttonStart" onClick={moveScroll}>
     <svg width="100%" className="play-svg" height="95%" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
